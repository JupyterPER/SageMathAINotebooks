...
function saveHtml() {
    ...
    const htmlContent = "<!DOCTYPE html>\n<html>\n<head>" +
        ...
        '<script src="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/js/nbrunner5.js"></script>\n' +
...
${currentQuery}
'''
language = '${currentLanguage}'; model='${currentModel}'; url = 'https://raw.githubusercontent.com/JupyterPER/SageMathAINotebooks/refs/heads/main/AIcommandsMistral%20NB%20player.py'; load(url); previous_code = r'''${previousCode}'''; AIanswer = ${aiCommand}(language=language, model=model, NBplayer_code=previous_code+f'In[FOCUS]: {prompt}', api_key='${apiKey}'); print(AIanswer)
# -END OF AI CELL-`;
