...
function makeMenu() {
    ...
    $("head").first().append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/css/nbplayer15.css"'), $("body").first().append('<script src="custom.js"><\/script>');
...
function saveHtml() {
    ...
    const htmlContent = "<!DOCTYPE html>\n<html>\n<head>" +
        ...
        '<script src="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/js/nbrunner17.js"></script>\n' +
...
function addControlPanel() {
    ...
    const linkElement = document.querySelector('link[href="https://dahn-research.eu/nbplayer/css/nbplayer14.css"]');
    if (linkElement) {
        linkElement.href = "https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/css/nbplayer14.css";
    }
