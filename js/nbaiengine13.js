...
#aiVisionModal .vm-tab.active {\
    color:#4CAF50; border-bottom-color:#4CAF50; font-weight:600;\
}\
...
#aiVisionModal .vm-dropzone.dragover {\
    border-color:#4CAF50; background:#f0faf0;\
}\
...
#aiVisionModal .vm-tool-btn.active { border-color:#4CAF50; background:#e0f2e0; }\
...
#aiVisionModal .vm-size-ctrl input[type="range"] {\
    width:70px; accent-color:#4CAF50;\
}\
...
#aiVisionModal .vm-add-draw-btn {\
    margin-top:8px; padding:7px 16px; background:#4CAF50;\
...
#aiVisionModal .vm-mode-label input[type="radio"] {\
    margin-right:8px; accent-color:#4CAF50;\
}\
