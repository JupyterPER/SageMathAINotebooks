...
function makeMenu() {
    ...
    var t = "de" == e ? "Code ausblenden/einblenden" : "Show / Hide Code",
        ...
        l = '<div id="navbar">' + ('Exec' == playerConfig.panes ? "" : s + o) + '<a href="#" role="button" class="btn btn-primary" onclick="toggleInput()" title="Hide/Show Code (Ctrl+Alt+H)">' + iconDictionaryNavbar["showHideCode"] + '</a>\n  <a href="#" role="button" class="btn btn-primary" onclick="saveHtml()" title="Save (Ctrl+Alt+S)">' + iconDictionaryNavbar["saveNotebook"] + "</a>" + '\n  </div>';
...
function saveHtml() {
    ...
    const htmlContent = "<!DOCTYPE html>\n<html>\n<head>" +
        ...
        '<script src="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/js/nbrunner8v2.js"></script>\n' +
...
function toggleEditMode() {
    ...
    if (editCellsButton) {
        ...
        editCellsButton.title = 'Edit/View Mode (Ctrl+Alt+E)';
    }
}
...
function addControlPanel() {
    ...
    runButton.title = 'Run All Cells (Ctrl+Alt+R)';

    const restartButton = document.createElement('button');
    restartButton.id = 'restartKernelButton';
    restartButton.innerHTML = iconDictionaryNavbar["restart"];
    restartButton.title = 'Restart Sage Kernel and Clear All Outputs (Ctrl+Alt+K)';
    ...
    toggleNavbarButton.title = 'Toggle Bar (Ctrl+Alt+T)';
    ...
    exportButton.title = 'Export Notebook (Ctrl+Alt+X)';
    ...
    importButton.title = 'Import Notebook (Ctrl+Alt+I)';
...
document.addEventListener('keydown', function (event) {
    ...
    if (event.ctrlKey && event.altKey) {
        ...
        const actions = {
            ...
            x: () => document.getElementById('exportCells')?.click(),
