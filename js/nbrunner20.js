...
function saveHtml() {
    ...
    const htmlContent = "<!DOCTYPE html>\n<html>\n<head>" +
        ...
        '<script src="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/js/nbrunner20.js"></script>\n' +
        '<script src="https://cdn.jsdelivr.net/gh/JupyterPER/SageMathAINotebooks@main/js/nbaiengine20.js"></script>\n' +
...
function addControlPanel() {
    ...
    toggleEvalButton.title = 'Toggle Run Buttons Visibility';
